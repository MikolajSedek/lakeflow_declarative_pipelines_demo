...
def test_build_create_schema_sql_correct_ddl(
    catalog: str, schema: str, expected: str
) -> None:
...
def test_build_create_schema_sql_invalid_name_raises(
    bad_catalog: str, bad_schema: str
) -> None:
